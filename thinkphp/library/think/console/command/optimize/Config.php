...
class Config extends Command
{
    ...
    {
        $this->setName('optimize:conf')
            ->addArgument('module', Argument::OPTIONAL, 'Build module conf cache .')
            ->setDescription('Build conf and common file cache.');
    }
    ...
    protected function buildCacheContent($module)
    {
        ...
        if ($module) {
            // 加载模块配置
            $config = ThinkConfig::load(CONF_PATH . $module . 'conf' . CONF_EXT);
